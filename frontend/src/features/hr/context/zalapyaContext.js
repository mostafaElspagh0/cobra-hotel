...
const ZalapyaContext = createContext()

const ZalapyaTableContextProvider = (props) => {
    ...
    return (
        <ZalapyaContext.Provider value={
            ...
            {props.children}
        </ZalapyaContext.Provider>
    )
}

export {ZalapyaContext, ZalapyaTableContextProvider}